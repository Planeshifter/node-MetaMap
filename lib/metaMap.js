(function() {
  ...
  exports.getConceptArray = function(resultSet) {
    var ret, utterances, _ref, _ref1, _ref2;
    ...
    if (Array.isArray(utterances) === true) {
      ret = _.flatten(utterances.map(function(u) {
        var _ref2;
        return (_ref2 = u.Phrases) != null ? _ref2.Phrase.map(function(p) {
          var _ref3;
      ...
      ret = _.flatten((_ref2 = utterances.Phrases) != null ? _ref2.Phrase.map(function(p) {
        var _ref3;
        return (_ref3 = p.Mappings) != null ? _ref3.Mapping : void 0;
      }).filter(function(p) {
        return p !== void 0;
